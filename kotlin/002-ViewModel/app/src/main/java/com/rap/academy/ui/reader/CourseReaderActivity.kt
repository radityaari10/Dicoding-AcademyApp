...
import com.rap.academy.ui.reader.content.ModuleContentFragment
import com.rap.academy.ui.reader.list.ModuleListFragment
...
class CourseReaderActivity : AppCompatActivity(), CourseReaderCallback {
    ...
    private fun populateFragment() {
        ...
        if (fragment == null) {
            fragment = ModuleListFragment.newInstace()
